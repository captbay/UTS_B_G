            ...
            if (mysqli_num_rows($query) == 0) {
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../process/pengembalianProcess.php?id=' . $data['id_buku'] . '"onClick="return confirm ( \'Are you sure want to return the book?\')"> <i class="fa fa-book" style="color:red"></i>
                            </a>
                        </td>
                    </tr>';
                    $no++;
